...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[90vh] px-4 text-center overflow-hidden pt-20">
        ...
        <div className="space-y-6 max-w-3xl animate-fade-in-up">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-8">
            ...
            <Link
              href="/contact"
              className="px-8 py-4 rounded-full border border-gray-700 hover:bg-gray-800 text-white transition-colors font-medium"
            >
              İletişime Geç
            </Link>
          </div>
      ...
      <section className="py-10 bg-gray-900/30 border-y border-gray-800 overflow-hidden">
        ...
        <div className="relative flex overflow-x-hidden group">
            <div className="flex animate-scroll whitespace-nowrap">
                {[...TECHNOLOGIES, ...TECHNOLOGIES].map((tech, index) => (
                    <span 
                        key={index} 
                        className="mx-8 text-2xl font-bold text-gray-400 hover:text-blue-400 transition-colors cursor-default"
                    >
                        {tech}
                    </span>
                ))}
